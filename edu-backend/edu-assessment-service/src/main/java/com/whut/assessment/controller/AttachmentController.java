...
public class AttachmentController {
    ...
    @RequireRole({UserRole.TEACHER, UserRole.ADMIN})
    @DeleteMapping("/assignments/attachments/{attachmentId}")
    public Result<Void> deleteAssignmentAttachment(@PathVariable Long attachmentId) {
        attachmentService.deleteAssignmentAttachment(attachmentId);
