...
-- ======================== 4. 选课数据 ========================
-- s1~s5 选课（通过 + 待审核）
INSERT INTO tb_enrollment (class_id, course_id, student_id, status, apply_reason, review_comment, applied_at, reviewed_at) VALUES
  -- s1 选了 5 门课
  (910101, 9101, 201, 1, '想学习 Java Web 开发', '通过', '2026-07-01 09:00:00', '2026-07-01 10:00:00'),
  (910201, 9102, 201, 1, '数据库是基础', '通过', '2026-07-01 09:01:00', '2026-07-01 10:01:00'),
  (920101, 9201, 201, 1, '对数据分析感兴趣', '通过', '2026-07-01 09:02:00', '2026-07-01 10:02:00'),
  (910501, 9105, 201, 1, '巩固算法基础', '通过', '2026-07-02 08:00:00', '2026-07-02 09:00:00'),
  (930101, 9301, 201, 0, '心理健康课', NULL, '2026-07-03 10:00:00', NULL),
  -- s2 选课
  (910101, 9101, 202, 1, '想学后端开发', '通过', '2026-07-01 09:10:00', '2026-07-01 10:10:00'),
  (920201, 9202, 202, 1, '前端开发有兴趣', '通过', '2026-07-01 09:11:00', '2026-07-01 10:11:00'),
  (930401, 9304, 202, 0, '英语需要提高', NULL, '2026-07-04 11:00:00', NULL),
  -- s3 选课
  (910301, 9103, 203, 1, '学习 MyBatis Plus', '通过', '2026-07-01 10:00:00', '2026-07-01 11:00:00'),
  (920301, 9203, 203, 1, 'AI 方向', '通过', '2026-07-01 10:01:00', '2026-07-01 11:01:00'),
  (940101, 9401, 203, 0, '开源项目实践', NULL, '2026-07-05 14:00:00', NULL),
  -- s4 选课
  (910401, 9104, 204, 1, '微服务架构', '通过', '2026-07-02 09:00:00', '2026-07-02 10:00:00'),
  (920401, 9204, 204, 1, '深度学习入门', '通过', '2026-07-02 09:01:00', '2026-07-02 10:01:00'),
  (910101, 9101, 204, 2, 'Java Web 选修', '学生主动退课', '2026-07-03 09:00:00', '2026-07-04 09:00:00'),
  -- s5 选课
  (910501, 9105, 205, 1, '数据结构重要', '通过', '2026-07-01 11:00:00', '2026-07-01 12:00:00'),
  (920501, 9205, 205, 1, '云计算方向', '通过', '2026-07-01 11:01:00', '2026-07-01 12:01:00'),
  (930501, 9305, 205, 4, '体育课名额已满', '名额已满，抱歉', '2026-07-06 08:00:00', '2026-07-06 09:00:00'),
  -- s6~s10 各选 2~3 门
  (910201, 9102, 206, 1, '数据库必修', '通过', '2026-07-02 10:00:00', '2026-07-02 11:00:00'),
  (930201, 9302, 206, 1, '职业指导课', '通过', '2026-07-02 10:01:00', '2026-07-02 11:01:00'),
  (940201, 9402, 207, 1, '企业项目实训', '通过', '2026-07-03 08:00:00', '2026-07-03 09:00:00'),
  (910301, 9103, 207, 1, 'MyBatis 深入学习', '通过', '2026-07-03 08:01:00', '2026-07-03 09:01:00'),
  (920601, 9206, 207, 1, '大数据技术', '通过', '2026-07-03 08:02:00', '2026-07-03 09:02:00'),
  (910401, 9104, 208, 1, 'Spring Boot 实践', '通过', '2026-07-04 09:00:00', '2026-07-04 10:00:00'),
  (930301, 9303, 208, 1, '中国近现代史', '通过', '2026-07-04 09:01:00', '2026-07-04 10:01:00'),
  (940301, 9403, 209, 1, '科技创新', '通过', '2026-07-05 10:00:00', '2026-07-05 11:00:00'),
  (920101, 9201, 209, 1, 'Python 数据分析', '通过', '2026-07-05 10:01:00', '2026-07-05 11:01:00'),
  (910501, 9105, 210, 1, '算法必修', '通过', '2026-07-06 08:00:00', '2026-07-06 09:00:00'),
  (930401, 9304, 210, 1, '英语四', '通过', '2026-07-06 08:01:00', '2026-07-06 09:01:00')
