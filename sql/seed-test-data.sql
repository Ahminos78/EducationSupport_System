...
INSERT INTO tb_enrollment (id, class_id, course_id, student_id, status, apply_reason, review_comment, applied_at, reviewed_at)
VALUES
    (9201, 910101, 9101, 9011, 1, '希望系统学习后端接口开发。', '基础匹配，通过选课。', '2026-07-01 09:00:00', '2026-07-01 10:00:00'),
    (9202, 910101, 9101, 9012, 1, '想完成毕业设计中的后端模块。', '通过。', '2026-07-01 09:30:00', '2026-07-01 10:10:00'),
    (9203, 910201, 9102, 9011, 0, '想熟悉 MyBatis Plus 的实际项目用法。', NULL, '2026-07-02 11:00:00', NULL),
    (9204, 910301, 9103, 9013, 4, '希望补充前端知识。', '本期名额暂不开放。', '2026-07-03 14:00:00', '2026-07-03 16:00:00'),
    (9205, 910301, 9103, 9012, 2, '先试听前端工程化课程。', '学生主动退课。', '2026-07-04 10:00:00', '2026-07-05 10:00:00')
ON DUPLICATE KEY UPDATE
    status = VALUES(status),
